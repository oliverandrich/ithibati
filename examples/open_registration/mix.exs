defmodule IthibatiOpen.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind ithibati_open", "esbuild ithibati_open"],
      "assets.deploy": [
        "tailwind ithibati_open --minify",
        "esbuild ithibati_open --minify",
        "phx.digest"
      ],
