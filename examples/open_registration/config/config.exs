...
config :ithibati,
  repo: IthibatiOpen.Repo,
  user_schema: IthibatiOpen.Accounts.User,
  users_key_type: :id

config :ithibati_open,
  ecto_repos: [IthibatiOpen.Repo],
...
config :ithibati_open, IthibatiOpenWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: IthibatiOpenWeb.ErrorHTML, json: IthibatiOpenWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: IthibatiOpen.PubSub,
