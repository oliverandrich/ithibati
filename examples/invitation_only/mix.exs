defmodule IthibatiInvites.MixProject do
  use Mix.Project

  def project do
    [
      app: :ithibati_invites,
      version: "0.1.0",
      elixir: "~> 1.18",
  ...
  def application do
    [
      mod: {IthibatiInvites.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind ithibati_invites", "esbuild ithibati_invites"],
      "assets.deploy": [
        "tailwind ithibati_invites --minify",
        "esbuild ithibati_invites --minify",
        "phx.digest"
      ],
