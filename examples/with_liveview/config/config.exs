...
config :ithibati,
  repo: IthibatiLive.Repo,
  user_schema: IthibatiLive.Accounts.User,
  users_key_type: :id

config :ithibati_live,
  ecto_repos: [IthibatiLive.Repo],
  generators: [timestamp_type: :utc_datetime]

# Configures the endpoint
config :ithibati_live, IthibatiLiveWeb.Endpoint,
  url: [host: "localhost"],
  adapter: Bandit.PhoenixAdapter,
  render_errors: [
    formats: [html: IthibatiLiveWeb.ErrorHTML, json: IthibatiLiveWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: IthibatiLive.PubSub,
