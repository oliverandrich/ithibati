...
defmodule Ithibati.Credo.NoBeanIds do
  ...
  # Assembled, so this check does not report itself. What stands in the
  ...
  # four characters, though, so a name like `<prefix>core` is reported too. That is accepted, and pinned in
  # the tests, so it is a decision and not a surprise.
  #
